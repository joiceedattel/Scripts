#!/bin/bash
####################################################################################
#Program name:mfcompleterestart.sh
#Version:1.1
#Modified by:Omkar A. Phadke
#Purpose:This script will clear cobol's cached memory & restart the SAO services.
####################################################################################
if [ $1 -eq '-v' ]
then
echo "Version 1.1"
...
touch /tmp/a.txt
sudo chown root:root /tmp/a.txt 2>/dev/null
if [ $? -ne 0 ]
then
echo "=================================================================="
echo "Inappropriate privileges,kindly contact monitoring team at ZO/CO"
echo "=================================================================="
exit
else
rm -rvf /tmp/a.txt 
